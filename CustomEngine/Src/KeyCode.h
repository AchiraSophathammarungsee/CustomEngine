...
#define KEY_COUNT           ::Key::KeyCount

#define MOUSE_LEFT    ::Mouse::ButtonLeft
#define MOUSE_RIGHT   ::Mouse::ButtonRight
#define MOUSE_MIDDLE  ::Mouse::ButtonMiddle
#define MOUSE_LAST    ::Mouse::ButtonLast
#define MOUSE_0       ::Mouse::Button0
#define MOUSE_1       ::Mouse::Button1
#define MOUSE_2       ::Mouse::Button2
#define MOUSE_3       ::Mouse::Button3
#define MOUSE_4       ::Mouse::Button4
#define MOUSE_5       ::Mouse::Button5
#define MOUSE_6       ::Mouse::Button6
#define MOUSE_7       ::Mouse::Button7
#define MOUSE_COUNT   ::Mouse::ButtonCount
